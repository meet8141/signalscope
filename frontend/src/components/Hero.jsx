...
export function Hero({ onUpload, isUploading, results, selectedFile }) {
  return (
    <section className="relative min-h-[70vh] pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-8 flex items-center max-w-[1400px] mx-auto">
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-10 items-center w-full">
        ...
        <div className="lg:col-span-6 relative h-[400px] lg:h-[500px] w-full flex justify-center lg:justify-end mb-4 lg:mb-0">
